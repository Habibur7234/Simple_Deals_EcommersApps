...
public class MainActivity extends AppCompatActivity {
    //code for login required
    private static int APP_REQUEST_CODE = 1971; // any number accepted
    ...
    private void showRegisterDialog(FirebaseUser user) {
        ...
        View itemView = LayoutInflater.from(this).inflate(R.layout.layout_register,null); // show layout register in dialog box
        ...
        builder.setView(itemView);  // set the item view so that show the register layout items
            ...
            userRef.child(user.getUid()).setValue(userModel)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            {
                                dialog.dismiss();
                                Toast.makeText(MainActivity.this, "Congrates! Registration Successful!", Toast.LENGTH_SHORT).show();
                                goToHomeActivity(userModel);
                            }
                        }
                    });
    ...
    private void goToHomeActivity(UserModel userModel) {
        ...
        FirebaseInstanceId.getInstance()
                ...
                .addOnFailureListener(e -> {
                    ...
                    Common.currentUser = userModel; //always assign value for it before use
